  ...
  <el-col :span="12">
    ...
    >
      ...
      <el-submenu index="3">
        ...
        <el-menu-item-group>
          <el-menu-item index="/outpatientConsumption">门诊消费记录</el-menu-item>
          <el-menu-item index="/OutpatientRecharge">门诊充值记录</el-menu-item>
          <el-menu-item index="/hospitaLization">住院消费记录</el-menu-item>
          <el-menu-item index="/HospitalizationRecharge">住院充值记录</el-menu-item>
      ...
      <el-submenu index="4">
        ...
        <el-menu-item-group>
          ...
          <el-menu-item index="/examinationPackage/physicalExamination">体检套餐</el-menu-item>
