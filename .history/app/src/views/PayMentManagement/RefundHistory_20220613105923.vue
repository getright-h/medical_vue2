    ...
    <template v-slot:mytable>
      <div>
        ...
        >
          ...
          <el-table-column prop="order_num" label="退款编号" width="120">
          </el-table-column>
          ...
          <el-table-column prop="pmode" label="退款方式" width="120">
          </el-table-column>
...
export default {
  ...
  mounted() {
    ...
    // 获取渲染的数据，从plugins中获取
    this.getTableData("/refund/queryRefund");
    //
    ...
    fn({ medcard, order_num }) {
      ...
      this.$router.push({
        ...
        params: {
          ...
          //备注接口的地址
          remarkurl: "/refund/updateOrderremark",
