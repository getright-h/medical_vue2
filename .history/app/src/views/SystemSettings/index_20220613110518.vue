<template >
  ...
  :inactive-value=0 @change="han(scope.row)">
     ...
     <el-table-column
      ...
      width="100">
      <template slot-scope="scope">
        <el-button @click="handleClick(scope.row)" type="text" size="big" class="el-icon-edit"></el-button>
        <el-button type="text" size="big" class="el-icon-delete-solid" @click="handle(scope.row)"></el-button>
      </template>
    </el-table-column>
  </el-table>
    </div>
