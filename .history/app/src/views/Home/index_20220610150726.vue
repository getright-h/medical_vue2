  ...
  <div>
    ...
    <section class="main">
      ...
      <div id="second-middle" ref="second-middle">
        ...
        <el-table :data="tableDataMiddle" stripe style="width: 100%">
          <el-table-column  label="排行" width="60">
          </el-table-column>
          <el-table-column prop="departmentname" label="科室名" width="80">
          </el-table-column>
          <el-table-column prop="departnum" label="预约量" width="80"> </el-table-column>
        </el-table>
      </div>
