      ...
      <div class="main-header">
        ...
        <ul class="clear">
          ...
          <li>
            ...
            <span class="num">500</span>
            <span class="numLang">今日门诊消费人数</span>
            <i class="el-icon-top-right"></i>
          </li>
          <li>
            <div class="ulDiv5">
            ...
            <span class="num">500</span>
            <span class="numLang">今日门诊充值人数</span>
            <i class="el-icon-top-right"></i>
          </li>
        </ul>
      </div>
      ...
      <div id="second-left" ref="second-left">
        ...
        <el-table :data="tableData" stripe style="width: 100%">
          <el-table-column  label="头像" width="80">
              <img src="../../assets/images/logo.png" alt="" style="width: 50px;height: 50px;border-radius: 50px;">
      </el-table-column>
          <el-table-column prop="name" label="姓名" width="80">
          </el-table-column>
          <el-table-column prop="phone" label="电话" width="120"> </el-table-column>
          <el-table-column prop="department" label="预约科室" width="80"> </el-table-column>
          <el-table-column prop="pay" label="挂号费" width="70"> </el-table-column>
          <el-table-column prop="time" label="挂号时间" width="160"> </el-table-column>
        </el-table>
      </div>
      <div id="second-middle" ref="second-middle"></div>
      <div id="second-right" ref="second-right"></div>
    </section>
  </div>
</template>
