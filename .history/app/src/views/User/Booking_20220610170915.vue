...
export default {
  methods: {
    async getData(){
      console.log(Number(JSON.parse(sessionStorage.getItem('user')).phone));
      let result = await this.$API.Booking({phone:Number(JSON.parse(sessionStorage.getItem('user')).phone)})
      console.log(result);
    },
