...
export default {
  ...
  methods: {
    ...
    async getData() {
      ...
      console.log("预约挂号信息", result.data);
      if (result.code == 200) {
    ...
    async lgetDatal() {
      ...
      // console.log("挂号科室信息", result.data);
      if (result.code == 200) {
        ...
        console.log(this.ruleForm.departmentmz,this.ruleForm.department);
        //   console.log("所有数据", this.ruleForm.administrativeoffice1);
        ...
        console.log("挂号医生信息22222", result2);
        if (result.code == 200) {
    ...
    async mdoctormy() {
      ...
      console.log("挂号医生信息", result.data);
      if (result.code == 200) {
        ...
        //   console.log("所有医生数据", this.ruleForm.doctormy1.data);
      }
    },
    ...
    async yhbalance() {
      ...
      console.log("用户余额信息", result.data);
      if (result.code == 200) {
