  ...
  >
    <el-form :model="form">
      ...
      <div class="block">
        ...
        <el-cascader size="large" :options="form.upOptions" v-model="form.upSelectedOptions">
        </el-cascader>
      </div>
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" @click="$emit('changeUpValue', false)"
        >确 定</el-button
      >
    </div>
  </el-dialog>
