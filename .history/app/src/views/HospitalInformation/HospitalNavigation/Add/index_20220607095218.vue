...
export default {
  ...
  methods: {
    ...
    async confirmAdd() {
      ...
      const thisCity =options.children.find(item => item.value === selectedOptions[1]).label
      console.log(thisCity);
      const thisCounty =options.children.children.find(item => itemvalue === selectedOptions[2]).label
