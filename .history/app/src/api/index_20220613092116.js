...
export const addRegisterRemark=(data)=>requests({url:'/reg/updateRemake',method:'put',data}) //添加挂号备注
...
export const reqmedicalSingleInfo=(data)=>requests({url:'/phy/phyOneInformation',method:'post',data}) //查看单条预体检详情
export const reqrepost=(data)=>requests({url:'/phy/reportExam',method:'get',params:{medcard:data}}) //查看体检报告
...
export const reqGOupdataAdim=(data)=>requests({url:'admin/preEditAdmin',method:'post',data})//进入修改接口
...
// 主表下拉框查询
export const doctorManagements1 =(data) => requests ({url: '/doc/QueryDoctors1',method:'post',data})
// 添加图片
export const doctorManagementAddUrl =(data) => requests ({url: '/DoctorPic',method:'post',data})
// 添加
export const doctorManagementAdd =(data) => requests ({url: '/doc/addDoctors',method:'post',data})
// 修改前查询接口
export const doctorManagementQMfy =(data) => requests ({url: '/doc/PreEditDoctors',method:'post',data})
//修改 
export const doctorManagementModify =(data) => requests ({url: '/doc/EditDoctors',method:'put',data})
// 修改label标签下拉列表
export const doctorManagementModifyLabel =(data) => requests ({url: '/doc/PreEditDoctorQueryLabel',method:'post',data})
// 修改科室下拉列表
export const doctorManagementModifyDept =(data) => requests ({url: '/doc/PreEditDoctorQueryDept',method:'post',data})
// 修改职称下拉列表
export const doctorManagementModifyProf =(data) => requests ({url: '/doc/PreEditDoctorQueryProf',method:'post',data})
...
//预约科室选择接口
export const administrativel = (params) => requests({url: '/make/departmentMake',method:'get',params})
//预约医生选择接口
...
//取消预约接口
export const deselecting = (params) => requests({url: '/update/updateStatus',method:'get',params})
//预约详情接口
export const Booking = (params) => requests({url: '/patientBook/patientInfo',method:'get',params})
//用户充值接口
export const czvoucher = (data) => requests({url: '/rerecord/rechargeBalance',method:'post',data})
//用户查询余额接口
export const cxvoucher = (data) => requests({url: '/rerecord/selectBalance',method:'post',data})

//医院百科接口
export const yybkencyclopedia = (data) => requests({url: '/doc/QueryEncyclopedia1',method:'post',data})
//医院百科模糊查询接口
export const cxencyclopedia = (data) => requests({url: '/doc/QueryEncyclopedia1',method:'post',data})
//医院百科新增接口
...
//医院百科修改前接口
export const encyclopedia = (data) => requests({url: '/doc/PreEditEncyclopedia',method:'post',data})
//医院百科修改接口
