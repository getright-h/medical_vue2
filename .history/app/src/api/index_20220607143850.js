...
export const reqUpdateHospitalNav = (data) => requests({url:`/doc/EditNavigationVo`,method:'put',data})
//医院导航删除院区接口

// /doc/DelNavigation
export const reqDeleteHospitalNav = (data) => requests({url:`/doc/DelNavigation`,method:'delete',data})
