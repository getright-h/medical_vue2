...
export const reqmedicalSingleInfo=(data)=>requests({url:'/phy/phyOneInformation',method:'post',data}) //查看单条预约核酸详情
...
//取消预约接口
export const deselecting = (params) => requests({url: '/update/updateStatus',method:'put',params})
//预约详情接口
