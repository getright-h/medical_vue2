<template>
  <el-dialog title="新增文章" :visible.sync="IsAdd" :before-close="Cancel">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
			<el-form-item label="文章标题" prop="title">
				<el-input v-model="ruleForm.title" placeholder="请输入内容"></el-input>
			</el-form-item>
			<!-- <el-form-item label="上传缩略图" prop="region">
                <el-upload
  ...
  export default {
    ...
    methods: {
		...
		confirm(){
			...
			// console.log('quill.root.innerHTML',quill.root.innerText);
		...
		async newly(){
			...
			// console.log('obj',obj);
			let loginl = await this.$API.addencyclopedia(obj)
			obj={}
			// console.log(loginl);
			if(loginl.code === 200){
...
<style scoped>
  ...
  .avatar {
	...
	#vue-editor-wrapper>div:nth-of-type(1){
