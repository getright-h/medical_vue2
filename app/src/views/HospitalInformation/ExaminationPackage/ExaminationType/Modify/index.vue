<template>
  <el-dialog title="修改套餐类型" :visible.sync="IsModify" :before-close="Cancel">
...
<script>
  export default {
	...
	clickUpdateRow(v1,v2){
		console.log('v1',v1);
		this.ruleForm.type=v1.type	//类型名称
        this.ruleForm.num=v1.num	//所含套餐数量
        this.ruleForm.combo=v1.combo	//包含套餐
        this.ruleForm.text=v1.text	//描述
