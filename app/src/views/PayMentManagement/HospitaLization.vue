    ...
    <template v-slot:mytable>
      <div>
        ...
        >
          ...
          <el-table-column prop="ctype" label="收费项目合计" width="120">
          </el-table-column>
...
export default {
  ...
  mounted() {
    ...
    // 获取渲染的数据，从plugins中获取
    this.getTableData("/exrecord/queryHospitalization");
    //
    ...
    this.$bus.$emit("updateSelect", {
      ...
      url: "/exrecord/selectHospitalization",
    });
  },
  methods: {
    //分页
